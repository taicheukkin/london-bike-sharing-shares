...
The **operational dashboard** help business make sense of the relationship between **weather/time** and **sport**, in order to allocate resource in specified weather condition or time to **optimize the revenue** effectively. In detail, how the **time** and **weather** in determining the **bike sharing shares** between 
...
- replace 1,2,3,4 in **season column** as **"spring"**,**"summer"**,**"autumn"** and **“winter"** respectively
...
- **correlation** between **actual_temperature** and **monthly moving average** of london_bike_sharing_shares is calculated over 24 months in 2 years.
...
The **seasonal peak** of monthly_moving_average in **August**,which is the average of **June,July and August** (the three months represent summer).It implied the more bike should be prepared for these three months.
...
- Both **orange** and **blue** color card showed  **strongly positve correlation** between **wind speed/actual temperature** and **london_bike_sharing** over **daytime** respectively 

The **combo chart** demonstrated both **wind_speed** and **temperature** follow the similar **seasonal trend** as london_bike_sharing.

 When no slicers were applied, 
 - the top 3 largest **average bike sharing shares** was wind speed bin **(5.65-11.29)(11.30-16.94)(16.95-22.59)** as a result of the **largest total bike sharing shares**.
